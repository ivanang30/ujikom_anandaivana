<?php
/**
 * FILE: cek_pembayaran/detail.php
 * DESKRIPSI: Halaman detail cek pembayaran siswa
 * FITUR:
 *   - Cari siswa berdasarkan NISN atau Nama
 *   - Tampilkan detail pembayaran siswa (sudah lunas dan belum lunas)
 *   - Tabel pembayaran yang sudah lunas
 *   - Tabel pembayaran yang belum lunas
 * ALGORITMA:
 *   1. Cek login user
 *   2. Jika ada parameter pencarian, cari siswa
 *   3. Jika siswa ditemukan, ambil detail pembayaran
 *   4. Tampilkan hasil pencarian dan detail pembayaran
 */
...
<head>
    ...
    <title>Cek Pembayaran Detail - Aplikasi SPP</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" style="padding: 30px;">
                <h2 class="mb-4">Cek Pembayaran Detail</h2>
