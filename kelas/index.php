        ...
        <div class="row">
            ...
            <div class="col-md-10" style="padding: 30px;">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2>Data Kelas</h2>
                    <a href="tambah.php" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Kelas</a>
                </div>

                <div class="card">
                    <div class="card-body">
                        <table id="tabelKelas" class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    <th>ID Kelas</th>
                                    <th>Nama Kelas</th>
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit.php?id_kelas=<?php echo $row['id_kelas']; ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                            <a href="hapus.php?id_kelas=<?php echo $row['id_kelas']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
