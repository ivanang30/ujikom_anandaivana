        ...
        <div class="row">
            ...
            <div class="col-md-10" style="padding: 30px;">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2>Data Petugas</h2>
                    <a href="tambah.php" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Petugas</a>
                </div>

                <div class="card">
                    <div class="card-body">
                        <table id="tabelPetugas" class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    <th>ID Petugas</th>
                                    <th>Username</th>
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                    <tr>
                                        ...
                                        <td><span class="badge bg-info"><?php echo ucfirst($row['level']); ?></span></td>
                                        <td>
                                            <a href="edit.php?id_petugas=<?php echo $row['id_petugas']; ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                            <a href="hapus.php?id_petugas=<?php echo $row['id_petugas']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
