...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $id_petugas = validasiInput($_POST['id_petugas']);
    ...
    $query = "INSERT INTO tb_petugas (id_petugas, username, password, nama_petugas, level) 
              VALUES ('$id_petugas', '$username', '$password', '$nama_petugas', '$level')";
    
    if (mysqli_query($koneksi, $query)) {
        redirect('index.php', 'Data petugas berhasil ditambahkan!');
    } else {
