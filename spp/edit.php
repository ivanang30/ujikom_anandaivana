...
if (!$spp) {
    redirect('index.php', 'Data SPP tidak ditemukan!');
}

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $tahun = validasiInput($_POST['tahun']);
    $nominal = validasiInput($_POST['nominal']);
    
    $query = "UPDATE tb_spp SET tahun='$tahun', nominal='$nominal' WHERE id_spp='$id_spp'";
    
    if (mysqli_query($koneksi, $query)) {
        redirect('index.php', 'Data SPP berhasil diperbarui!');
    } else {
...
<head>
    ...
    <title>Edit SPP - Aplikasi SPP</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2 sidebar">
                ...
                <a href="index.php" class="active"><i class="fas fa-money-bill"></i> Data SPP</a>
            ...
            <div class="col-md-10" style="padding: 30px;">
                <h2 class="mb-4">Edit Data SPP</h2>
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="id_spp" value="<?php echo $spp['id_spp']; ?>" readonly>
                            </div>

                            <div class="mb-3">
                                <label for="tahun" class="form-label">Tahun</label>
                                <input type="number" class="form-control" id="tahun" name="tahun" value="<?php echo $spp['tahun']; ?>" required>
                            </div>

                            <div class="mb-3">
                                <label for="nominal" class="form-label">Nominal (Rp)</label>
                                <input type="number" class="form-control" id="nominal" name="nominal" value="<?php echo $spp['nominal']; ?>" required>
                            </div>
