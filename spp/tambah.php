...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO tb_spp (id_spp, tahun, nominal) VALUES ('$id_spp', '$tahun', '$nominal')";
    
    if (mysqli_query($koneksi, $query)) {
        redirect('index.php', 'Data SPP berhasil ditambahkan!');
    } else {
...
<head>
    ...
    <title>Tambah SPP - Aplikasi SPP</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" style="padding: 30px;">
                <h2 class="mb-4">Tambah Data SPP</h2>
